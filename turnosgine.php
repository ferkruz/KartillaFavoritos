...
/*prueba php kargar turnos en array bd y borrado!!!! ok!!!!!ssssss
...
?> 
  ...
  <!--  <ul class="list mat-ripple">      
   ...
   <ul class="nav control mat-ripple tiny">
      ...
      <i class="mdi mdi-account-multiple"></i><span class='name'> Prev. gineco-mamaria</span>
      </li>
  ...
  <div id="contact-modal" data-mode="add" class="card dialog">
    ...
    <script type="text/javascript">
    		function cita(){
			 ...
			 //var fav=document.getElementById("new-user0").value;
			var salvcita=""+"../adddatepprev.php?pres="+dock+"&cita="+date+"&afi="+ <?php echo $nom ?> +"&tip="+ <?php echo $tipodoku ?>+"&prog=Prevención ginecologica";
...
switch (docky) { 
	...
	if (currentDateTime.getDay() == 1){
		<?php	
	mysql_select_db($database_connec, $connec);
	$query_turnos = "SELECT * FROM tbl_turnospprev WHERE prest='Dra. Fabiana Rico'";
	$turnos = mysql_query($query_turnos, $connec) or die(mysql_error());
	$row_turnos = mysql_fetch_assoc($turnos); 
	$totalRows_turnos = mysql_num_rows($turnos);
	...
	$horas=array ("'13:00'","'13:30'","'14:00'","'14:30'","'15:00'","'15:30'");
...
$kalendartotal="['13:00','13:30','14:00','14:30','15:00','15:30']";?>
...
if (currentDateTime.getDay() == 4){
	...
	$horas=array ("'08:00'","'08:30'","'09:00'","'09:30'","'10:00'","'10:30'","'11:00'","'11:30'");
...
<?php 
$kalendartotal="['08:00','08:30','09:00','09:30','10:00','10:30','11:00','11:30']";?>
...
if ((diaokupa == <?php echo $diaokupa ?>)&&(mesokupa == <?php echo $mesokupa ?>)&&(anhookupa == <?php echo $anhookupa ?>)){
		alert (<?php echo $horas ?>);
			...
			if ($index!==false)
			array_splice($horas, $index, 1);
			$kalendar="[".$horas[0].",".$horas[1].",".$horas[2].",".$horas[3].",".$horas[4].",".$horas[5].",".$horas[6].",".$horas[7].",".$horas[8]."]"; 
			?>
			//horas=['13:00','13:30','14:00','14:30','15:30'];
			alert ("123"+<?php echo $horas?>);
			this.setOptions({
			timepicker: true,			
			//allowTimes: horas,
			allowTimes: <?php echo $kalendar;?>
...
<?php $kalendartotal="['13:00','13:30','14:00','14:30','15:00','15:30']";?>
...
if ((currentDateTime.getDay() == 2)||(currentDateTime.getDay() == 5)||(currentDateTime.getDay() == 6)||(currentDateTime.getDay() == 7)){
		    this.setOptions({
			timepicker: false,			
			allowTimes:[]
		});
...
break;
	...
	if ((currentDateTime.getDay() == 1)){
		<?php	
	mysql_select_db($database_connec, $connec);
	$query_turnos = "SELECT * FROM tbl_turnospprev WHERE prest='Dra. Ana Chertkoff'";
	$turnos = mysql_query($query_turnos, $connec) or die(mysql_error());
	$row_turnos = mysql_fetch_assoc($turnos); 
	$totalRows_turnos = mysql_num_rows($turnos);
...
<?php $kalendartotal="['08:00','08:30','09:00','09:30','10:00','10:30','11:00','11:30']";?>
...
break;
	...
	$horas=array ("'14:00'","'14:30'","'15:00'","'15:30'","'16:00'","'16:30'","'17:00'","'17:30'");
...
<?php $kalendartotal="['14:00','14:30','15:00','15:30','16:00','16:30','17:00','17:30']";?>
